...
export default class DraftsList extends Component {
  private canSchedule: boolean =
    ...
    app.forum.attribute("drafts.enableScheduledDrafts");
  ...
  view() {
    ...
    if (draft.scheduledValidationError())
      scheduledDraftIcon = "far fa-calendar-times";
        ...
        >
          ...
          <span class="Notification-title">
            <span className="Notification-content">
              {draft.type() === "reply"
                ? draft.loadRelationships().discussion.title()
                : draft.title()}
            </span>
          ...
          <div class="Notification-action">
            ...
            <Tooltip
              text={app.translator.trans(
                "fof-drafts.forum.dropdown.delete_button"
              )}
            >
              <Button
                data-container="body"
            ...
            {this.canSchedule ? (
              <Tooltip
                text={app.translator.trans(
                  "fof-drafts.forum.dropdown.schedule_button"
                )}
              >
                <Button
                  data-container="body"
          ...
          {draft.scheduledValidationError() ? (
            <p className="scheduledValidationError">
              {draft.scheduledValidationError()}
            </p>
          ) : (
            ""
